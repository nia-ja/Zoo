...
class TestElephant(unittest.TestCase):
    ...
    def test_get_obj_description_returns_obj_age(self):
        e = elephant.Elephant(5)
        desc = e.get_obj_description()

        self.assertEqual(5, desc)
    
    def test_get_obj_failures_returns_zero_on_init(self):
        e = elephant.Elephant(5)
        failures = e.get_obj_failures()

        self.assertEqual(0, failures)

    def test_get_obj_failures_returns_right_amount_of_failures(self):
        e = elephant.Elephant(5)
        e.failures = 2
        failures = e.get_obj_failures()
    ...
    def test_get_obj_id_returns_id(self):
